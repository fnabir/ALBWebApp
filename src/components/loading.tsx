...
export default function Loading({ isPage = true }: { isPage?: boolean }) {
  return (
    <div
      className={`absolute flex items-center justify-center w-full ${
        isPage ? 'h-screen bg-background' : 'h-full bg-transparent'
      }`}
    >
      <div className="flex-col">
        <div
          className="relative overflow-hidden rounded-lg w-48 h-28 mx-auto
