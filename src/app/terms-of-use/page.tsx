    ...
    <PageLayout>
      ...
      <section className="py-10 px-4 sm:px-8">
        <div className="max-w-4xl mx-auto space-y-6">
          <p>
            These Terms of Use govern your use of our website and services. By
          ...
          <p>
            ...
            bound by these terms. If you do not agree to all the terms, then you
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              You agree not to disrupt the site or servers connected to the
              site.
            </li>
            <li>
          ...
          <p>
            ...
            images, is the property of Asian Lift Bangladesh or its content
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Impersonation or misrepresentation of your affiliation with any
              person or entity.
            </li>
          ...
          <p>
            Asian Lift Bangladesh shall not be liable for any indirect,
          ...
          <p>
            These Terms constitute the entire agreement between you and Asian
            Lift Bangladesh regarding the use of our services and supersede any
            prior agreements.
          </p>
