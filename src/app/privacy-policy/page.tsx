      ...
      <section className="py-10 px-4 sm:px-8">
        <div className="max-w-4xl mx-auto space-y-6">
          <p>
            ...
            and disclosure of your information when you use the service. It also
            tells you about your privacy rights and how the law protects you.
          </p>

          <p>
            Your privacy is important to Asian Lift Bangladesh. We&apos;ve
            developed this Privacy Policy to describe how we collect, use,
          ...
          <p>
            <strong>Interpretation:</strong> The words where the initial letter
            is capitalized have meanings defined under the following conditions.
          </p>
          <p>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              <strong>Company:</strong> refers to Asian Lift Bangladesh.
            </li>
            <li>
              <strong>
                Account, Website, Mobile Applications, Service, Country, Service
                Provider, Personal Data, Cookies
              </strong>{" "}
              are all defined terms.
            </li>
          </ul>
          ...
          <p>
            <strong>Types of Data Collected:</strong> We may collect your email
            address, name, phone number, and usage data.
          </p>
          <p>
            <strong>Usage Data:</strong> Collected automatically when using the
            service, including browser type, pages visited, time and date of
          ...
          <p>
            We retain your personal data only as long as necessary for legal or
          ...
          <p>
            <strong>What is a Cookie?</strong> Cookies are small files stored on
            your device that collect standard internet log information.
          </p>
          <p>
            <strong>Use of Cookies:</strong> We use cookies to improve
            functionality and user experience.
          </p>
          <p>
            <strong>Do Not Track:</strong> We support DNT browser settings.
          </p>
          <p>
            <strong>Controlling Cookies:</strong> You can control or delete
          ...
          <p>
            Your data may be processed outside your jurisdiction, including to
          ...
          <p>
            <strong>Business Transactions:</strong> Your data may be transferred
            in a merger or acquisition.
          </p>
          <p>
            <strong>Law Enforcement:</strong> We may disclose data as required
            by law.
          </p>
          <p>
          ...
          <p>
            We may collect non-personal data such as browser language, region,
            or system settings for analytics.
          </p>

          <h2 className="text-2xl font-semibold mt-8">Your Privacy Rights</h2>
          <p>
            You have rights to access, correct, delete, or object to the use of
            your personal data.
          </p>
          <ul className="list-disc list-inside space-y-1">
          ...
          <p>
            We enforce companywide privacy standards and regularly review our
            practices.
          </p>
          ...
          <p>
            We use industry-standard practices to secure your personal data.
          ...
          <p>
            We are not responsible for the content or privacy policies of
          ...
          <p>
            ...
            notified of any changes via email or our website.
          </p>
          ...
          <ul className="list-none space-y-1">
            <li>
              Email:{" "}
              <a
                href="mailto:contact@asianliftbd.com"
                className="text-blue-400 hover:underline"
              >
                contact@asianliftbd.com
              </a>
            </li>
            <li>
              Visit:{" "}
              <Link href="/contact" className="text-blue-400 hover:underline">
                asianliftbd.com/contact
              </Link>
            </li>
          </ul>
        </div>
