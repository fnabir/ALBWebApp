  ...
  return (
    <PageLayout>
      ...
      <PageSection
        ...
        subheading="We prefer you to make an appointment beforehand to make sure we can serve you best when you will visit us."
      >
          ...
          <Card className="col-span-1 max-w-md mx-auto text-xl text-center gap-4 flex justify-center">
            <CardContent className="space-y-6">
              ...
              <div className="text-[15px] text-muted-foreground">
                Do not use this form for sales related query. <br />
                Please email us for other queries.
              </div>
            </CardContent>
          </Card>
